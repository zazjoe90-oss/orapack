...
export default function Blog({ limit, showAllButton = true }: BlogProps) {
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {displayedPosts.map((post, index) => (
            ...
            >
              <Link 
                to={`/blog/${post.slug}`}
                className="bg-white rounded-[2.5rem] overflow-hidden shadow-xl shadow-black/[0.03] border border-black/5 group flex flex-col h-full transition-all hover:shadow-2xl hover:shadow-brand-red/5 hover:-translate-y-1"
              >
                ...
                <div className="p-8 flex flex-col flex-grow">
                  ...
                  <div className="pt-6 border-t border-black/5">
                    <div className="flex items-center gap-2 text-brand-red font-black uppercase tracking-widest text-xs group/btn">
